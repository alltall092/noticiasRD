...
useEffect(()=>{
  axios.get('https://noticiasnodejs2.onrender.com/api/v1/noticiasrecientes').then(res=>setRecientes(res.data))


},[]);

useEffect(()=>{
axios.get('https://noticiasnodejs2.onrender.com/api/v1/noticias/').then(res=>setFiltered(res.data.imageUrls))
...
axios.get('https://noticiasnodejs2.onrender.com/api/v1/category').then(res=>setDatos(res.data));

...
axios.get(`https://noticiasnodejs2.onrender.com/api/v1/noticias/${id}`).then(res=>setDatos(res.data));

},[]);
useEffect(()=>{

axios.get('https://noticiasnodejs2.onrender.com/api/v1/noticiasrecientes').then(res=>setFindFilter(res.data));

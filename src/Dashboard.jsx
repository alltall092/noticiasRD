...
axios.get('https://noticiasnodejs2.onrender.com/api/v1/noticias/').then(res=>setNoticias(res.data.imageUrls));
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get('https://noticiasnodejs2.onrender.com/api/v1/news');
  ...
  const chartStyle = {
    ...
    useEffect(()=>{
axios.get('https://noticiasnodejs2.onrender.com/api/v1/categories').then(res=>setDatos(res.data));
...
const getContactos=()=>{
  ...
  axios.get('https://noticiasnodejs2.onrender.com/api/v1/contactos').then(res=>setContactos(res.data));
...
const getUser=()=>{
  ...
  axios.get('https://noticiasnodejs2.onrender.com/api/v1/users').then(res=>setUser(res.data));
}
...
const deleteUser=(id)=>{
axios.delete(`https://noticiasnodejs2.onrender.com/api/v1/users/${id}`).then(()=>getUser()).catch(err=>console.log("algo salio mal",err))
...
const deleteContactos=(id)=>{
  ...
  axios.delete(`https://noticiasnodejs2.onrender.com/api/v1/contactos/${id}`).then(()=>getContactos()).catch(err=>console.log('algo salio mal'));
...
const enviar=(datos)=>{
axios.put(`https://noticiasnodejs2.onrender.com/api/v1/users/${userId}`,{

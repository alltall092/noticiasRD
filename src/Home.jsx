...
axios.get('https://noticiasnodejs2.onrender.com/api/v1/noticiasprincipales').then(res=>setDatos(res.data));

},[]);

useEffect(()=>{
axios.get('https://noticiasnodejs2.onrender.com/api/v1/categories').then(res=>setCat(res.data));
